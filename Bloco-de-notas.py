...
window: object = sg.Window('Bloco de notas', layout=layout, margins=(0, 0), resizable=True, return_keyboard_events=True)
...
def about_me():
    sg.PopupQuick('Author: Igor Luiz', auto_close=False)
